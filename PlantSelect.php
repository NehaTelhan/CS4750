   ...
   <form action="PlantSelect.php" method="post">
            <div id="custom-search-input">
                <div class="input-group col-md-12">
                    <input type="text" id="commonname" name="commonname" class="form-control input-lg" placeholder="Type To Search" />
...
$sql="SELECT * FROM Plant WHERE Common_Name LIKE '$commonname'";
...
if (!mysqli_query($con,$sql))
  ...
  {
    echo "Displaying results for $common_name";
